...
ActiveRecord::Schema.define(:version => 20120713191451) do
  ...
  create_table "user_skill_relations", :force => true do |t|
    t.integer  "user_id"
    t.integer  "skill_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "user_skill_relationships", :force => true do |t|
    t.integer  "user_id"
    t.integer  "skill_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
